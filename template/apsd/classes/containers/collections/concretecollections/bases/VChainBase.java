...
public class VChainBase<Data> implements Chain<Data> {
    ...
    public void NewChain(DynVector<Data> vec) {
        this.vec = vec;
    }
    ...
    public Data FirstNRemove() {
        return (!IsEmpty()) ? vec.FirstNRemove() : null;
    }
    ...
    public Data LastNRemove() {
        return (!IsEmpty()) ? vec.LastNRemove() : null;
    }
    ...
    public void RemoveOccurrences(Data dat) {
        Filter(elem -> (dat == null) ? (elem != null) : !dat.equals(elem));
    }
